              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mb-1 opacity-80">
                    ...
                    <span className="text-[13px] font-display tracking-widest uppercase" style={{ color: event.color }}>
                      {event.year}
                    </span>
                  </div>
                  ...
                  <p className="text-s text-muted-foreground font-body leading-relaxed">
                    {event.desc}
                  </p>
                </div>
