...
export default function Hero() {
  ...
  useEffect(() => {
    const targetDate = new Date("2026-03-13T08:30:00").getTime();
  ...
  return (
    <section id="home" className="relative min-h-screen w-full overflow-hidden bg-background flex flex-col items-center justify-center pt-32 md:pt-40 pb-20">
        ...
        >
          ...
          <div className="relative mb-8 group">
            ...
            <h1 className="font-display text-5xl md:text-8xl font-black tracking-tighter leading-none relative">
              <span className="relative inline-block">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 drop-shadow-[0_0_15px_rgba(34,211,238,0.3)]">CYBERTHON'26</span>
                {/* Scanning Laser Line */}
                <motion.span
          ...
          >
            <a
              ...
              className="group relative px-10 py-4 bg-cyan-500 text-black font-display text-xs font-bold tracking-[0.2em] uppercase overflow-hidden transition-all duration-300 hover:scale-105 active:scale-95"
            >
