      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex md:justify-end gap-6">
            <a href="https://www.linkedin.com/company/center-for-cybersecurity-empowerment-and-excellence" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:text-cyan-400 hover:border-cyan-500 hover:bg-cyan-500/5 transition-all">
              <Linkedin size={20} />
            </a>
            <a href="https://discord.gg/RBFAuRYWGx" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center text-white/50 hover:text-pink-500 hover:border-pink-500 hover:bg-pink-500/5 transition-all">
