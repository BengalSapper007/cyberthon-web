...
import { Link, EarthLock, Server, Landmark, HardDrive, Globe, Bitcoin, Search, Brain, ArrowUpRight } from "lucide-react";
import { cn } from "@/lib/utils";

const tracks = [
  { icon: Globe, title: "Web Security", desc: "Find and exploit web vulnerabilities in real-world apps." },
  { icon: HardDrive, title: "IOT & Hardware Security", desc: "Find and exploit web vulnerabilities in real-world apps." },
  { icon: Brain, title: "AIML Security", desc: "Find and exploit web vulnerabilities in real-world apps." },
  { icon: Landmark, title: "Fin Tech Security", desc: "Find and exploit web vulnerabilities in real-world apps." },
  { icon: Search, title: "DFIR Security", desc: "Reverse engineer mobile apps and uncover fatal flaws." },
  { icon: Server, title: "Cloud Security", desc: "Smart contract auditing and DeFi exploit challenges." },
  { icon: EarthLock, title: "Dark Web Security", desc: "Binary analysis, malware dissection, and CTF puzzles." },
  { icon: Link, title: "Web3 Security", desc: "Investigate breaches and recover critical evidence." },
  { icon: Bitcoin, title: "Crypto Security", desc: "Adversarial ML, prompt injection, and AI safety." },
];
